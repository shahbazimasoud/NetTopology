    ...
    >
      ...
      <div className="bg-white p-3.5 rounded-lg border border-slate-200 shadow-sm flex flex-wrap items-center justify-between gap-3">
        <div>
          <div className="flex items-center gap-2">
            <h2 className="text-base font-bold text-slate-900">{t('scanner_title')}</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
        <div className="p-3.5 rounded-lg bg-white border border-slate-200 shadow-sm flex items-center justify-between">
          <div>
            <div className="text-slate-500 text-[11px]">{t('scanner_metric_total')}</div>
        ...
        <div className="p-3.5 rounded-lg bg-white border border-slate-200 shadow-sm flex items-center justify-between">
          <div>
            <div className="text-slate-500 text-[11px]">{t('scanner_metric_cdp')}</div>
        ...
        <div className="p-3.5 rounded-lg bg-white border border-slate-200 shadow-sm flex items-center justify-between">
          <div>
            <div className="text-slate-500 text-[11px]">{t('scanner_metric_lldp')}</div>
      ...
      <div className="p-3 rounded-lg bg-white border border-slate-200 shadow-sm text-xs text-slate-600 grid grid-cols-1 md:grid-cols-2 gap-3">
        <div className="p-2.5 rounded bg-slate-50 border border-slate-200">
          <div className="font-bold text-indigo-700 mb-0.5 font-mono text-xs">{t('scanner_explain_cdp_title')}</div>
          <p className="text-[11px] text-slate-500 leading-relaxed">
            {t('scanner_explain_cdp_desc')}
          </p>
        </div>
        <div className="p-2.5 rounded bg-slate-50 border border-slate-200">
          <div className="font-bold text-purple-700 mb-0.5 font-mono text-xs">{t('scanner_explain_lldp_title')}</div>
          <p className="text-[11px] text-slate-500 leading-relaxed">
      ...
      <div className="bg-white border border-slate-200 rounded-lg overflow-hidden shadow-sm">
        <div className="p-3 border-b border-slate-200 flex flex-wrap items-center justify-between gap-2.5 text-xs">
          <div className="flex items-center gap-2">
            <h3 className="font-bold text-slate-900">{t('scanner_table_title')}</h3>
            <span className="text-slate-500 text-[11px]">{t('scanner_records_count', { count: filteredNeighbors.length })}</span>
          </div>
          ...
          <table className={`w-full ${isRtl ? 'text-right' : 'text-left'} text-xs`}>
            <thead>
              <tr className="bg-slate-50 text-slate-600 border-b border-slate-200 font-medium text-[11px] uppercase tracking-wider">
                <th className="p-3">{t('scanner_col_local_device')}</th>
                <th className="p-3">{t('scanner_col_local_port')}</th>
                <th className="p-3">{t('scanner_col_remote_device')}</th>
                <th className="p-3">{t('scanner_col_neighbor_ip')}</th>
                <th className="p-3">{t('scanner_col_remote_port')}</th>
                <th className="p-3">{t('scanner_col_model')}</th>
                <th className="p-3">{t('scanner_col_protocol')}</th>
                <th className="p-3">{t('scanner_col_capabilities')}</th>
                <th className="p-3">{t('scanner_col_vlan')}</th>
                <th className="p-3">{t('scanner_col_holdtime')}</th>
              </tr>
            </thead>
